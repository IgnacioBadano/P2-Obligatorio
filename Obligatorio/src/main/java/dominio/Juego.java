...
public class Juego {
    ...
    private ArrayList<String> historialJugada;
    ...
    public ArrayList<String> getHistorialJugada() {
        return historialJugada;
    }

    public void setHistorialJugada(ArrayList<String> historialJugada) {
        this.historialJugada = historialJugada;
    }
    ...
    public String mover(Coordenada coordenada) {
        if (tablero.coordenadaValida(coordenada.getFilaOrigen(), coordenada.getColumnaOrigen())) {
            if (cualquierLugar || (historialJugada.size() == 0 || (tablero.existeElastico(coordenada.getFilaOrigen(), coordenada.getColumnaOrigen())))) {
                if (suficienteBandas(coordenada.getCuantas())) {
                    ...
                    if (respuesta.equals("")) {
                        ...
                        cambiarTurno();
                        historialJugada.add(coordenada.getCoordenada());
                    }
