...
public class Interfaz {
            ...
            while (!cadenaCoordenada.equalsIgnoreCase("X") && juego.continuar()) {
                ...
                switch (cadenaCoordenada) {
                    case "X":
                        ...
                        break;
                    case "H":
                        mostrarHistorial(juego.getHistorialJugada());
                        break;
                    default:
    ...
    private static void mostrarHistorial(ArrayList<String> historialJugada) {
        for (String jugada : historialJugada) {
            System.out.println(historialJugada);
        }
    }
